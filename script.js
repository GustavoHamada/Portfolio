...
const surpresas = [
  "🌙 Sou mais produtivo(a) à noite do que de manhã.",
  "🍦 Nunca consigo decidir o sabor do sorvete na hora — demoro demais!",
  "💡 Tive minha melhor ideia de projeto enquanto tomava banho.",
  "🎲 Já tentei criar regras para um jogo de tabuleiro que nunca terminei.",
  "🌈 Minha cor favorita mudou pelo menos 4 vezes nos últimos 2 anos.",
  "🤫 Fico falando em voz baixa enquanto leio código — ajuda a entender.",
  "🎯 Já tentei aprender várias coisas ao mesmo tempo — quase nenhuma funcionou!",
];
...
// 5. BOTÃO MEU JOGO abre as duas imagens letheus e letheuss
const btnMeuJogo = document.getElementById('btnMeuJogo');
if (btnMeuJogo) {
  btnMeuJogo.addEventListener('click', (event) => {
    event.preventDefault();
    window.open('imagens/letheus.jpeg', '_blank');
    window.open('imagens/letheuss.jpeg', '_blank');
  });
}

// 6. TOAST ao clicar na Peppa
